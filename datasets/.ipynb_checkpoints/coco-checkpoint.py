...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
         "train": (root / "positive image set", root / 'train.json'),
         "train_reg": (root / "positive image set", root / 'train.json'),
         "val": (root / "positive image set", root / 'test.json'),
         "eval_debug": (root / "positive image set", root / 'test.json'),
    }
